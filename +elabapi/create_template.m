function [output, json_output] = create_template()
    % Create a new template 
    %
    %% Description:
    % This function is part of eLabAPI and creates a new template. 
    %   
    %% Syntax:
    %   create_template()
    % or
    %   [RESULT, json_RESULT] = create_template()
    %
    %% Input:
    %   [-]
    %
    ...
    %
    params = struct();
    json_output = elabapi.send_req('templates',params,'create');
